...
function ActionMovie({ UrlData, title }) {
  ...
  console.log(error, loading, navigate);
  const handleScrollyLeft = () => {
    const clientWidth = ref.current.clientWidth;
  ...
  return (
    <div className="content_movie">
      ...
      <div className="bgiconleft" onClick={handleScrollyLeft}>
        <ChevronLeftIcon id="icon_left" sx={{ fontSize: "50px" }} />
      </div>
      <div className="bgiconright" onClick={handleScrollyRight}>
